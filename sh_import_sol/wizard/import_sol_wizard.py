...
class import_sol_wizard(models.TransientModel):
    ...
    def show_success_msg(self, counter, skipped_line_no):
        ...
        action = self.env.ref('sh_import_sol.sh_import_sol_action').read()[0]
                        ...
                        try:
                            ...
                            if sheet.cell(row, 0).value != '': 
                                ...
                                if self.product_by == 'name':
                                    ...
                                    field_nm = 'barcode'
                                print("\n\n\n\nfield_nm", field_nm)
                                search_product = self.env['product.product'].sudo().search([(field_nm, '=', sheet.cell(row, 0).value)], limit=1)
