...
#         return res
    ...
    def create(self, vals):
        ...
        _sql = """SELECT  COALESCE(MAX(id),'0') from product_product limit 1"""
        ...
        vals['barcode'] =str(int(count)+1).zfill(6)
        
        
        rec = super(ProductAutoBarcode, self).create(vals)
        return rec
...
#         return templates
    ...
    def create(self, vals):
        ...
        _sql = """SELECT  COALESCE(MAX(id),'0') from product_template limit 1"""
        self.env.cr.execute(_sql)
        ...
        rec = super(ProductTemplateAutoBarcode, self).create(vals)
        return rec
