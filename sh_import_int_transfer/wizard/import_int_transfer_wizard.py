        ...
        if self and self.file and self.location_id and self.location_dest_id and self.scheduled_date:
            ...
            if self.import_type == 'csv':
                ...
                try:
                    ...
                    search_warehouse  = self.location_id.get_warehouse()
                    if not search_warehouse:
                    ...
                    for t_row in range(sheet.nrows):
                        ...
                        if t_row != 0 and (not search_picking_type or not t_search_uom or not t_search_product or not t_search_product.type in ['product', 'consu']):
                            is_all_valid = False
                            break
