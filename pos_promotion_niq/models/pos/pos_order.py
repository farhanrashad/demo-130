...
class PosOrder(models.Model):
    ...
    def _action_create_invoice_line(self, line=False, invoice_id=False):
        inv_line = super(PosOrder, self)._action_create_invoice_line(line, invoice_id)
        promotion_disc_vals = {
            'promo_disc_percentage': line.promo_disc_percentage,
            'promo_disc_amount': line.promo_disc_amount,
            'promo_fixed_price': line.promo_fixed_price,
            'promo_get_free': line.promo_get_free
        }
        inv_line.write(promotion_disc_vals)
        return inv_line

    def compute_unit_price(self, line):
    ...
    #     def action_create_account_move_line(self, session=None, move=None):
    ...
    #                 price = self.compute_unit_price(line)
    ...
    #             move.sudo().post()
    #         return True
    #     self._patch_method("_create_account_move_line",
    #         action_create_account_move_line)
