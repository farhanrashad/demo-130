...
odoo.define('pos_orders_list.pos_orders_list', function(require) {
	...
	// Start SeeOrdersButtonWidget
	
	var SeeOrdersButtonWidget = screens.ActionButtonWidget.extend({
		template: 'SeeOrdersButtonWidget',
		button_click: function() {
			...
			this.gui.show_screen('see_orders_screen_widget');
		},
	...
	screens.define_action_button({
		...
		'widget': SeeOrdersButtonWidget,
		'condition': function() {
			return true;
		},
	});
	// End SeeOrdersButtonWidget 

	// SeeAllOrdersScreenWidget start

	var SeeOrdersScreenWidget = screens.ScreenWidget.extend({
		template: 'SeeOrdersScreenWidget',
		...
		get_orders_fields: function () {
			var fields = ['name', 'id', 'date_order', 'partner_id', 'pos_reference', 'lines', 'amount_total', 'session_id', 'state', 'company_id','pos_order_date','barcode','barcode_img'];
			return fields;
		},
	...
	gui.define_screen({
		name: 'see_orders_screen_widget',
		widget: SeeOrdersScreenWidget
	});
